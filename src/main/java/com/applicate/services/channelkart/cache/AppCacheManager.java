...
public class AppCacheManager {
    ...
    private AppCacheEventPublisher eventPublisher;
    ...
    public AppCacheEventPublisher getEventPublisher() {
        if (eventPublisher == null) {
            this.eventPublisher = AppCacheEventPublisher.get();
        }
    ...
    public void removeAll(String lob) {
            try {
                if(isRoot()){
