...
public class SchemeCalculationService extends AbstractCDMService<SchemeCalculation> {
    ...
    public SchemeCalculationService() {
        ...
        schemeMustBuyGroupService = new SchemeMustBuyGroupService();
    }
    ...
    public List<SchemeCalculation> scSave(List<SchemeCalculation> schemeCalculations, DSLContext transDSL) {
        ...
        for (SchemeCalculation schemeCalculation : schemeCalculations) {
            ...
            List<SchemeMustBuyGroup> schemeMustBuyGroupList = schemeMustBuyGroupService.findBySchemeId(schemeCalculation.getSchemeId());
            if (NullUtils.isNotNull(schemeMustBuyGroupList))
                schemeMustBuyGroupService.smbSave(schemeMustBuyGroupList);
            List<SchemeFreeproductinfo> schemeFreeproductinfoList = schemeFreeProductInfoService.findBySchemeId(schemeCalculation.getSchemeId());
            if(NullUtils.isNotNull(schemeFreeproductinfoList))
                schemeFreeProductInfoService.sfpSave(schemeFreeproductinfoList);
        }
