...
public class LocationService extends AbstractCDMService<Location> {
    ...
    public LocationService(DSLContext dsl) {
        super(dsl);
        this.dsl = dsl;
        metaDataService = new MetaDataService(dsl);
        locationRepository = new LocationRepository(dsl);
    }
...
//				logger.warn("Location level config not found in metadata. Switching to default.");
            ...
            Iterator<org.apache.flink.shaded.jackson2.com.fasterxml.jackson.databind.JsonNode> iter = arraynode.elements();
            while (iter.hasNext()) {
...
//					locationColumns, e2.getLocalizedMessage());
    ...
    public com.salescode.dim.jooq.generated.tables.pojos.Location refresh(Location loc){
        com.salescode.dim.jooq.generated.tables.pojos.Location savedLoc = dsl.selectFrom(CK_LOCATION)
                .where(CK_LOCATION.LOCATION_HIERARCHY.eq(loc.getLocationHierarchy()))
                .fetchOneInto(com.salescode.dim.jooq.generated.tables.pojos.Location.class);
    ...
    public Location save(Location loc,com.salescode.dim.jooq.generated.tables.pojos.Location  savedLoc){
       ...
       CkLocationRecord record = dsl.newRecord(CK_LOCATION,loc);
    ...
    @Override
    public Location save(Location cdmObject) {
        return null;
    }
}
