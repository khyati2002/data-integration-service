...
import com.applicate.services.channelkart.annotation.FilterKey;
...
import com.applicate.services.channelkart.converters.HierarchyMetaDataListDeserializer;
import com.applicate.services.channelkart.converters.HierarchyMetaDataToStringConverter;
import com.applicate.services.channelkart.converters.LocationDeserializer;
import com.applicate.services.channelkart.converters.LocationToStringConverter;
import com.applicate.services.channelkart.integration.IntegrationEntities;
...
public class User extends CommonDataModel {
	...
	@NotNull
	@Size(min = 1, max = 50)
	@FilterKey(value = FilterKey.Key.LOGIN_ID,isDefaultKey = true, isImmediateParentAccess = true)
