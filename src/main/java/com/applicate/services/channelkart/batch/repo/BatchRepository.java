package com.applicate.services.channelkart.batch.repo;
...
public class BatchRepository {
   ...
   public List<HashAwareData> getDuplicateHashes(Class<? extends CommonDataModel> model, Set<String> hashes) {
      ...
      String query = "select new com.applicate.services.channelkart.batch.repo.HashAwareData(m.id, m.version, m.hash) from %s m where m.hash in :hashes";
