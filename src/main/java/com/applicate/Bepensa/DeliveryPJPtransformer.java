...
public class DeliveryPJPtransformer extends AbstractTransformer<Map<String, Object>, Map<String, Object>> {
    ...
    private final CustomerAccountsService accountsService = SpringContext.getBean(CustomerAccountsService.class);
    ...
    public List<Map<String, Object>> transform(Map<String, Object> inputMap) {
        ...
        if (responseList.isEmpty()) {
            throw new TransformationException("Day not available for the current month");
        }
        return responseList;
    }
    ...
    private DayOfWeek getDayOfWeek(int day) {
        switch (day) {
            ...
            default:
                throw new TransformationException("Invalid day value: " + day);
        }
    }
