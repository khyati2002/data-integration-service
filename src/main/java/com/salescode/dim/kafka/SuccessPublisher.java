...
public class SuccessPublisher {
    private static final Logger LOG = LoggerFactory.getLogger(SuccessPublisher.class);
    private final KafkaProducer<String, StreamingRawData> producer;
    private final String topicName;
    private final MailboxExecutor executor;

    public SuccessPublisher(Properties kafkaProps, String topicName, MailboxExecutor flinkExecutor) {
