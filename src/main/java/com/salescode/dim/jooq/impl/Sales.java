...
public class Sales extends com.salescode.dim.jooq.generated.tables.pojos.Sales implements Serializable {
    ...
    public Sales(com.salescode.dim.jooq.generated.tables.pojos.Sales sales) {
        super(sales);
    }

    public static Sales of(com.salescode.dim.jooq.generated.tables.pojos.Sales sales) {
        if(sales == null) {
            return null;
        }
