...
public class Stock extends CommonDataModel {
    ...
    public Stock(String skuCode, Double caseQty, Double pieceQty, Double otherQty, String batchId, String supplier, String warehouseId, String shelfLife, String mfgDate) {
        super();
