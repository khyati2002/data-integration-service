...
public class CkKpiInfo extends TableImpl<Record> {
 ...
 //   public final TableField<Record, ActiveStatus> ACTIVE_STATUS = createField(DSL.name("active_status"), SQLDataType.VARCHAR(255), this, "", new ActiveStatusConverter());
    ...
    private CkKpiInfo(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public CkKpiInfo as(Table<?> alias) {
        return new CkKpiInfo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CkKpiInfo rename(Table<?> name) {
        return new CkKpiInfo(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CkKpiInfo where(Condition condition) {
        return new CkKpiInfo(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CkKpiInfo where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CkKpiInfo where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CkKpiInfo where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CkKpiInfo where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CkKpiInfo where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CkKpiInfo where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CkKpiInfo where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CkKpiInfo whereExists(Select<?> select) {
     ...
     */
    @Override
    public CkKpiInfo whereNotExists(Select<?> select) {
