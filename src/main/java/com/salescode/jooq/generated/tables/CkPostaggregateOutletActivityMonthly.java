...
public class CkPostaggregateOutletActivityMonthly extends TableImpl<Record> {

    private static final long serialVersionUID = 1L;

    /**
     * The reference instance of
     * <code>ck_postaggregate_outlet_activity_monthly</code>
     */
    public static final CkPostaggregateOutletActivityMonthly CK_POSTAGGREGATE_OUTLET_ACTIVITY_MONTHLY = new CkPostaggregateOutletActivityMonthly();
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.id</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.hash</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.lob</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.source</code>.
     */
    public final TableField<Record, String> SOURCE = createField(DSL.name("source"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.version</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.images</code>.
     */
    public final TableField<Record, JSON> IMAGES = createField(DSL.name("images"), SQLDataType.JSON, this, "");

    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.name</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.month</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.year</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.loginid</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_outlet_activity_monthly.changed</code>.
     */
    ...
    /**
     * Create an aliased <code>ck_postaggregate_outlet_activity_monthly</code>
     * table reference
     */
    public CkPostaggregateOutletActivityMonthly(String alias) {
        this(DSL.name(alias), CK_POSTAGGREGATE_OUTLET_ACTIVITY_MONTHLY);
    }
     ...
     * table reference
     */
    public CkPostaggregateOutletActivityMonthly(Name alias) {
        this(alias, CK_POSTAGGREGATE_OUTLET_ACTIVITY_MONTHLY);
    }

    /**
     * Create a <code>ck_postaggregate_outlet_activity_monthly</code> table
     * reference
     */
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_CK_POSTAGGREGATE_OUTLET_ACTIVITY_MONTHLY_PRIMARY;
    }
    ...
    @Override
    public CkPostaggregateOutletActivityMonthly as(String alias) {
        return new CkPostaggregateOutletActivityMonthly(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public CkPostaggregateOutletActivityMonthly rename(String name) {
        return new CkPostaggregateOutletActivityMonthly(DSL.name(name), null);
    }
