...
public class CkPostaggregateUserConstantActivityMonthly extends TableImpl<Record> {
    ...
    private CkPostaggregateUserConstantActivityMonthly(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> CkPostaggregateUserConstantActivityMonthly(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, CK_POSTAGGREGATE_USER_CONSTANT_ACTIVITY_MONTHLY);
    }
