...
public class CkPostaggregateGlobalConstantActivity extends TableImpl<Record> {
    ...
    private CkPostaggregateGlobalConstantActivity(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> CkPostaggregateGlobalConstantActivity(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, CK_POSTAGGREGATE_GLOBAL_CONSTANT_ACTIVITY);
    }
