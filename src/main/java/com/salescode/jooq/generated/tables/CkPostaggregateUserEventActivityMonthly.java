...
public class CkPostaggregateUserEventActivityMonthly extends TableImpl<Record> {

    private static final long serialVersionUID = 1L;

    /**
     * The reference instance of
     * <code>ck_postaggregate_user_event_activity_monthly</code>
     */
    public static final CkPostaggregateUserEventActivityMonthly CK_POSTAGGREGATE_USER_EVENT_ACTIVITY_MONTHLY = new CkPostaggregateUserEventActivityMonthly();
    ...
    /**
     * The column <code>ck_postaggregate_user_event_activity_monthly.id</code>.
     */
    ...
    /**
     * The column <code>ck_postaggregate_user_event_activity_monthly.lob</code>.
     */
    ...
    /**
     * Create an aliased
     * <code>ck_postaggregate_user_event_activity_monthly</code> table reference
     */
    public CkPostaggregateUserEventActivityMonthly(String alias) {
        this(DSL.name(alias), CK_POSTAGGREGATE_USER_EVENT_ACTIVITY_MONTHLY);
    }
     ...
     * <code>ck_postaggregate_user_event_activity_monthly</code> table reference
     */
    public CkPostaggregateUserEventActivityMonthly(Name alias) {
        this(alias, CK_POSTAGGREGATE_USER_EVENT_ACTIVITY_MONTHLY);
    }

    /**
     * Create a <code>ck_postaggregate_user_event_activity_monthly</code> table
     * reference
     */
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.KEY_CK_POSTAGGREGATE_USER_EVENT_ACTIVITY_MONTHLY_PRIMARY;
    }

    @Override
    public CkPostaggregateUserEventActivityMonthly as(String alias) {
        return new CkPostaggregateUserEventActivityMonthly(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public CkPostaggregateUserEventActivityMonthly rename(String name) {
        return new CkPostaggregateUserEventActivityMonthly(DSL.name(name), null);
    }
