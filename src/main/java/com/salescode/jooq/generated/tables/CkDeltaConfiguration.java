...
public class CkDeltaConfiguration extends TableImpl<Record> {
    ...
    private CkDeltaConfiguration(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> CkDeltaConfiguration(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, CK_DELTA_CONFIGURATION);
    }
