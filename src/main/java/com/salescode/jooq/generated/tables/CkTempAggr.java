...
public class CkTempAggr extends TableImpl<Record> {
    ...
    private CkTempAggr(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> CkTempAggr(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, CK_TEMP_AGGR);
    }
