...
public class CkOutletDetails extends CommonDataModel implements Serializable {
    ...
    private transient CkUser retailerInfo;
    private List<CkHierarchyMetadata> immediateParent;


    public CkOutletDetails(DSLContext dsl, CkOutletDetails value) {
        this.dsl = dsl;
        this.id = value.id;
...
//    private List<CkHierarchyMetadata> immediateParent;
    ...
    public List<CkHierarchyMetadata> getImmediateParent(String outletId) {
        return dsl.select(CK_HIERARCHY_METADATA.fields())
                .from(CK_HIERARCHY_METADATA)
                .join(CK_OUTLET_DETAILS_HIERARCHYMETADATA)
                .on(CK_OUTLET_DETAILS_HIERARCHYMETADATA.HIERARCHY_METADATA_ID.eq(CK_HIERARCHY_METADATA.ID))
                .where(CK_OUTLET_DETAILS_HIERARCHYMETADATA.OUTLET_ID.eq(outletId)) // Filter by outletId
                .fetchInto(CkHierarchyMetadata.class); // Fetch the result into a list of CkHierarchyMetadata
    }

    public void setImmediateParent(List<CkHierarchyMetadata> immediateParent, CkOutletDetails outletDetails){
           //update-allfields of hierarchy_metadata
           //update id for outlet_details_hierarchy_metadata
           //can be max-one ?
    }
...
//    }
     ...
     */
    public void setLocationHierarchy(CkLocation location) {
...
//    )
    ...
    public CkLocation getLocation(CkOutletDetails outletDetails) {
        return dsl.selectFrom(CK_OUTLET_DETAILS)
                .where(CK_OUTLET_DETAILS.LOCATION_HIERARCHY.eq(outletDetails.locationHierarchy))
                .fetchOneInto(CkLocation.class);
    }

    public CkLocation getLocationHierarchy(CkOutletDetails outletDetails) {
        return getLocation(outletDetails);
    }

    public void setLocation(CkLocation location){
         this.locationHierarchy = location.getLocationHierarchy();
    }

    public void setRetailerInfo(CkUser retailerInfo){
