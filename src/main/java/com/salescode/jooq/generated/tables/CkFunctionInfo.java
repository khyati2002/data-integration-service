...
public class CkFunctionInfo extends TableImpl<Record> {

    private static final long serialVersionUID = 1L;

    /**
     * The reference instance of <code>ck_function_info</code>
     */
    public static final CkFunctionInfo CK_FUNCTION_INFO = new CkFunctionInfo();
    ...
    /**
     * The column <code>ck_function_info.active_status_reason</code>.
     */
    ...
    /**
     * The column <code>ck_function_info.changed</code>.
     */
    ...
    /**
     * The column <code>ck_function_info.extended_attributes</code>.
     */
    ...
    /**
     * The column <code>ck_function_info.hash</code>.
     */
    public final TableField<Record, String> HASH = createField(DSL.name("hash"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ck_function_info.last_modified_time</code>.
     */
     ...
     */
    public final TableField<Record, JSON> PARAMETERS_INFO = createField(DSL.name("parameters_info"), SQLDataType.JSON, this, "");

    /**
     * The column <code>ck_function_info.return_type</code>.
     */
    ...
    /**
     * Create an aliased <code>ck_function_info</code> table reference
     */
    public CkFunctionInfo(String alias) {
        this(DSL.name(alias), CK_FUNCTION_INFO);
    }

    /**
     * Create an aliased <code>ck_function_info</code> table reference
     */
    public CkFunctionInfo(Name alias) {
        this(alias, CK_FUNCTION_INFO);
    }

    /**
     * Create a <code>ck_function_info</code> table reference
     */
    ...
    @Override
    public CkFunctionInfo as(String alias) {
        return new CkFunctionInfo(DSL.name(alias), this);
    }

    @Override
    public CkFunctionInfo as(Name alias) {
     ...
     */
    @Override
    public CkFunctionInfo rename(String name) {
        return new CkFunctionInfo(DSL.name(name), null);
    }
