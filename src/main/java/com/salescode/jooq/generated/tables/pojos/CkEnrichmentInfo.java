...
public class CkEnrichmentInfo extends CommonDataModel implements Serializable {
    ...
    @ConstructorProperties({ "id", "activeStatus", "activeStatusReason", "createdBy", "creationTime", "extendedAttributes", "lastModifiedTime", "lob", "modifiedBy", "version", "description", "implementation", "language", "phase", "priority", "severity", "type", "source", "hash", "changed" })
    public CkEnrichmentInfo(
        @Nonnull String id,
