...
public class CkConsentInfo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> FEATURE = createField(DSL.name("feature"), SQLDataType.VARCHAR(500).defaultValue(DSL.inline("none", SQLDataType.VARCHAR)), this, "");
