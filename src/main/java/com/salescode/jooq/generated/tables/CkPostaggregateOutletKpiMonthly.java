...
public class CkPostaggregateOutletKpiMonthly extends TableImpl<Record> {
    ...
    private CkPostaggregateOutletKpiMonthly(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> CkPostaggregateOutletKpiMonthly(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, CK_POSTAGGREGATE_OUTLET_KPI_MONTHLY);
    }
    ...
    public CkLocation ckLocation() {
        if (_ckLocation == null)
            _ckLocation = new CkLocation(this, Keys.FK9XUGQ9JS0RR3HJTV4II2I4382);
    ...
    public CkUser ckUser() {
        if (_ckUser == null)
            _ckUser = new CkUser(this, Keys.FKJMB9EGO3VVQIK80PV9G7JAUIO);
    ...
    public CkOutletDetails ckOutletDetails() {
        if (_ckOutletDetails == null)
            _ckOutletDetails = new CkOutletDetails(this, Keys.FKC82ELO1XVFQCX1YCXBG8WS65V);
