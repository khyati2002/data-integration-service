...
public class CkPostaggregateOutletRecommendedActivityDaily extends TableImpl<Record> {
     ...
     */
    public static final CkPostaggregateOutletRecommendedActivityDaily CK_POSTAGGREGATE_OUTLET_RECOMMENDED_ACTIVITY_DAILY = new CkPostaggregateOutletRecommendedActivityDaily();
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.id</code>.
     */
    public final TableField<Record, String> ID = createField(DSL.name("id"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.active_status</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.created_by</code>.
     */
    public final TableField<Record, String> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.creation_time</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.extended_attributes</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.hash</code>.
     */
    public final TableField<Record, String> HASH = createField(DSL.name("hash"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.last_modified_time</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.reference_number</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.target_key</code>.
     */
    ...
    /**
     * The column
     * <code>ck_postaggregate_outlet_recommended_activity_daily.is_recommended</code>.
     */
    public final TableField<Record, String> IS_RECOMMENDED = createField(DSL.name("is_recommended"), SQLDataType.VARCHAR(255), this, "");
    ...
    /**
     * Create an aliased
     * <code>ck_postaggregate_outlet_recommended_activity_daily</code> table
     * reference
     */
    public CkPostaggregateOutletRecommendedActivityDaily(String alias) {
        this(DSL.name(alias), CK_POSTAGGREGATE_OUTLET_RECOMMENDED_ACTIVITY_DAILY);
    }
     ...
     * reference
     */
    public CkPostaggregateOutletRecommendedActivityDaily(Name alias) {
        this(alias, CK_POSTAGGREGATE_OUTLET_RECOMMENDED_ACTIVITY_DAILY);
    }

    /**
     * Create a <code>ck_postaggregate_outlet_recommended_activity_daily</code>
     * table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.CK_POSTAGGREGATE_OUTLET_RECOMMENDED_ACTIVITY_DAILY_CK_PA_OUTLET_RECO_IDX_1, Indexes.CK_POSTAGGREGATE_OUTLET_RECOMMENDED_ACTIVITY_DAILY_CK_PA_OUTLET_RECO_IDX_2);
    }
    ...
    @Override
    public CkPostaggregateOutletRecommendedActivityDaily as(String alias) {
        return new CkPostaggregateOutletRecommendedActivityDaily(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public CkPostaggregateOutletRecommendedActivityDaily rename(String name) {
        return new CkPostaggregateOutletRecommendedActivityDaily(DSL.name(name), null);
    }
