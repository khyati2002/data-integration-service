...
public class JarScanner {
    ...
    public HashMap<String, ResourcesInfo> scan(String jarDirectory) throws Exception {
        ...
        try (URLClassLoader cl = new URLClassLoader(new URL[]{new URL(jarDirectory)}, this.getClass().getClassLoader())) {
...
//            return "validation";
//        }else if(AbstractQueryExecuter.class.isAssignableFrom(rc)){
//            return "query";
//        }else if(AbstractTransformer.class.isAssignableFrom(rc)){
//            return "transformer";
//        }else if(AbstractEnrichment.class.isAssignableFrom(rc)){
//            return "enrichment";
//        }else if(AbstractTaskExecutor.class.isAssignableFrom(rc)){
//            return "task";
//        }else if(EventListener.class.isAssignableFrom(rc)){
