...
import static com.salescode.dis.insights.enums.ProgressStage.PROCESS;
import static com.salescode.dis.insights.enums.ProgressStage.SAVE;


@Component
@RequiredArgsConstructor
@Slf4j
public class StreamletSyncOperationStrategy implements IFileOperationStrategy {
    ...
    public ModeOfIntegration getModeOfIntegration() {
        return ModeOfIntegration.CK_STREAMLET_SYNC;
    }

    @Override
    public List<ProgressStage> getSupportedStages() {
        return List.of(PROCESS, SAVE);
    }
}
