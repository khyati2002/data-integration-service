...
public class InsightsEnabledFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(request.getRequestURI().contains("hckeck") || request.getRequestURI().contains("summary") || request.getRequestURI().contains("unit") || request.getRequestURI().contains("modes") || (!request.getRequestURI().startsWith("/api/") && (!request.getRequestURI().contains("master") || !request.getRequestURI().contains("job")))) {
