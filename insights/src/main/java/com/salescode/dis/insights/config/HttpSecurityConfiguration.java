    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        .requestMatchers("/hckeck","/status","/api/properties/**","/api/modes","/api/integration-stats","/api/sse/health", "/api/sse/status", "/api/*/master/*/unit/*/progress","/api/update-duplicate-counts").permitAll()
